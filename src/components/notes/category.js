...
const categoryInit = () => {
      ...
      <li class="${newCategory ? 'category-item' : 'category-item confirmation'}" ${newCategory ? `data-js="${categoryProps.categoryId}"` : ''}>
         ...
         <div class="container-options">
            ...
            <div class="${newCategory ? 'container-confirmation' : 'container-confirmation show'} center-flex">
               <button class="btn-confirm-category btn-default" data-js="confirmationAddCategory">
               ...
               <button class="btn-undo-category btn-default btn-wrapper-default" data-js="removeCategory">
   ...
   const categoryActions = {
      ...
      "addNewCategory"() {
         renderCategory({ newCategory: false });         
      ...
      "getCategories"() {
         (async () => {
            ...
            categories.forEach(
               ...
               renderCategory({ newCategory: true, categoryId, categoryName })
            );
         })();
      }
   }
